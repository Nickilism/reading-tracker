...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="{{FAVICON_PREFIX}}icons/apple-touch-icon.png">
  <link rel="apple-touch-icon" sizes="152x152" href="{{FAVICON_PREFIX}}icons/apple-touch-icon-152x152.png">
  <link rel="apple-touch-icon" sizes="167x167" href="{{FAVICON_PREFIX}}icons/apple-touch-icon-167x167.png">
  <link rel="icon" type="image/x-icon" href="{{FAVICON_PREFIX}}icons/favicon.ico">
  ...
  <style>
    ...
    *, *::before, *::after {
    ...
    .book-info { /* block layout; dates float right inside */ }
    ...
    @media (max-width: 480px) {
      /* Mobile: compact top header to match homepage (index.html) */
      body {
