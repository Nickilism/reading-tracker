...
<head>
  ...
  <script>window.onerror=function(m,s,l,c){return true;};</script>
  <script>var _h=document.querySelector('html');_h&&(_h.setAttribute('data-theme',localStorage.getItem('theme_color')||(window.matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light')));</script>
